...
Those totals are the ceiling. An offense that ran the ball 450 times last year (most likely) is not going to run it 600 times this year because you like their new back. While shifts can happen, they need to be within reason. Starting from the team keeps you honest about that. It also catches things you'd otherwise miss, like a receiver on a team that barely passed can look fine by his own stats and terrible once you see how small the pie was.
